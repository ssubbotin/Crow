...
namespace crow
{
    ...
    private:
        ...
        void do_write_chunked()
        {
            ...
            // The provider and the completion handler are taken out of the response so that
            // they survive any bookkeeping done on the response while the body is being written.
